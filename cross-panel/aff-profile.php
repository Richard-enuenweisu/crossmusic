...
if (isset($_POST['submit'])) {
  # code...
	...
	if (empty($errors)) {
	$stmt = $pdo->prepare("UPDATE aff_userstbl SET `password` = :npassword WHERE account_id =:acc_id");
	$stmt->execute([':npassword' => $hashed, ':acc_id'=>$affiliate_id]); 
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-md-8 pusher">								
									...
									<hr>
									<form action="aff-profile.php" method="POST" class="push">										
