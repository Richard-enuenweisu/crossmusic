...
if (isset($_GET['pending'])) {
	# code...
	$trans_query = $pdo->query("SELECT * FROM artist_trasanctionstbl WHERE `reference` = 'Pending' ORDER BY id DESC");
	$row = $trans_query->rowcount();	
}else{
	$trans_query = $pdo->query("SELECT * FROM artist_trasanctionstbl ORDER BY id DESC");
	$row = $trans_query->rowcount();	
}
...
<style type="text/css">
	.table-responsive img{
		...
		height: 65px;
			...
			<div class="u-content">
				<div class="u-body">
					<h1 class="h2 font-weight-semibold mb-4">Artist Transactions</h1>
					<div class="card">
<!-- 						<header class="card-header">														
 ...
 -->
						<div class="card-body">
							<h2 class="h3 card-header-title push">All Artist Transactions</h2>
									...
									?>
										<tr>
											...
											<td class="text-center">
												...
												<a class="badge badge-soft-info" href="admin-payout.php?artist=<?=$transacions['account_id']?>">
													Make Payment
												</a>
												<?php }else{ ?>
