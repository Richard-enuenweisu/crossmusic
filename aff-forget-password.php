...
if (isset($_POST['login'])) {
    ...
    $stmt = $pdo->prepare('SELECT * FROM aff_userstbl INNER JOIN aff_accounttbl ON aff_accounttbl.id = aff_userstbl.account_id WHERE aff_userstbl.email = ?');
    $stmt->execute([$email]);
    $row = $stmt->rowcount();
  ...
  $mail = new PHPMailer(true);
      ...
      //Recipients
      $mail->setFrom('hello.mycrossmusic@gmail.com', 'Crossmusic');
                                        ...
                                        <tr>
                                            <td align="center" valign="middle" style="padding-right:40px;padding-bottom:60px;padding-left:40px">
                                                <table border="0" cellspacing="0" cellpadding="0">
                                                    <tbody><tr>
                                                        <td align="center" bgcolor="#007C89"><a href="http://localhost/cross/aff-reset-password.php?ref='.$resetlink.'&affiliate='.$u_id.'" style="border-radius:0;border:1px solid #007c89;color:#ffffff;display:inline-block;font-size:16px;font-weight:400;letter-spacing:.3px;padding:20px;text-decoration:none;font-family:Helvetica Neue,Helvetica,Arial,Verdana,sans-serif;" target="_blank">Reset Password</a>
                                                        </td>
                                                    </tr>
                                                </tbody></table>
                                            </td>
...
<div class="container">
	<div class="music-page-flex pusher-3">		
		<div class="col-md-6 mylogin-holder" style="padding: 0px;">
			<form class="mylogin" method="POST" action="aff-forget-password.php">				
				<h4>Affiliate Forget Password</h4>
        <div class="row">
          <div class="col-12">
